...
import { useDeleteAllData, useGetCallerUserProfile, useSaveCallerUserProfile } from '../hooks/useQueries';
...
import { Shield, Trash2, User, Loader2, CheckCircle } from 'lucide-react';
      ...
      <Card className="bg-surface border-border">
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            This is your unique Internet Identity. Your data is keyed to this principal — only you can access it.
          </p>
        </CardContent>
      </Card>
          ...
          <div className="flex items-start justify-between gap-4 p-4 bg-destructive/5 border border-destructive/20 rounded-xl">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                This will permanently remove all your transactions and profile data. This action cannot be undone.
              </p>
            </div>
            <AlertDialog>
              ...
              <AlertDialogContent className="bg-surface border-border">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="text-muted-foreground">
                    This will permanently delete all your transaction data and profile. You will be logged out. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
