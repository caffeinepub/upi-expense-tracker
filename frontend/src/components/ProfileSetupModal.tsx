...
export default function ProfileSetupModal() {
  ...
  return (
    <Dialog open={true}>
      <DialogContent className="bg-surface border-border sm:max-w-md" onInteractOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <DialogTitle className="text-foreground text-xl">Welcome! Set up your profile</DialogTitle>
          </div>
          <DialogDescription className="text-muted-foreground">
            Tell us your name to personalize your experience. This is stored securely on-chain.
          </DialogDescription>
        </DialogHeader>
