...
import { ChevronRight, Eye, Loader2, Lock, Shield } from "lucide-react";
        ...
        <section className="max-w-7xl mx-auto w-full px-6 pt-12 pb-16 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight tracking-tight">
              Know where your <span className="text-mint">money goes</span>
              <br />
              every month
            </h1>
            <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
              Upload your UPI transaction export and instantly see your spending
              broken down by category — food, travel, entertainment, and more.
              All data stays private, on-chain, and under your control.
            </p>
        ...
        <section className="py-16 max-w-7xl mx-auto px-6 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              {
                step: "01",
                title: "Export from UPI app",
                desc: "Download your transaction history as CSV from GPay, PhonePe, or Paytm.",
              },
              {
                step: "02",
                title: "Upload & auto-categorize",
                desc: "We parse the file in your browser and classify each transaction automatically.",
              },
              {
                step: "03",
                title: "View your insights",
                desc: "See monthly totals, category breakdowns, and individual transactions — all private.",
              },
            ].map((s) => (
              <div
                key={s.step}
